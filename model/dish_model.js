...
var dish={
    ...
    addDish:function(item,callback){
        return db.query("insert into dish_tbl (dish_name,dish_price,dish_img,fk_cusines_id) values (?,?,?,?)",[item.dish_name,item.dish_price,item.dish_img,item.fk_cusines_id],callback);
    },
